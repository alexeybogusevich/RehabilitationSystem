...
def create_report(output_file, spacing = 1):
    ...
    pdf.cell(200, 10, txt="1. Функціональна програма «Бігова доріжка»  /до втоми/", ln=1, align="C")
    ...
    pdf.cell(200, 12, txt="ПРИЗГАЧЕННЯ :    Інд. Заняття       ФЕС ____________      Нордична хода    ЗАЛ  ІР", ln=1)
    ...
    pdf.cell(200, 10, txt='        Реабілітолог______________                   '+
    '                                                                              Лікар_________________', ln=1)
